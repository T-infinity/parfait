...
std::vector<std::vector<int>> buildNode2Cell(const std::shared_ptr<Parfait::ParallelMesh>& mesh) {
...
int findNeighbor(const std::vector<std::vector<int>>& n2c, const int* cell, int cell_length) {
...
std::vector<int> SurfaceNeighbors::buildSurfaceNeighbors(const std::shared_ptr<Parfait::ParallelMesh>& mesh) {
