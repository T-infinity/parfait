...
struct GSWeights {
    public:
        GSWeights(double a, double b, double c, double d, double e, double f)
...
template <typename PointCollection, typename Point>
auto calcLeastSquaresGradient(const PointCollection& points, const Point& center, const GSWeights& gs, const std::vector<double>& u, double u0);
