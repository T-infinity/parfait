#ifndef PARALLEL_MESH_IMPORTER_H
#define PARALLEL_MESH_IMPORTER_H
...
class ParallelMeshImporter
{
	public:
		ParallelMeshImporter(std::vector<std::string> gridFiles,std::vector<bool> &isBigEndian);
		~ParallelMeshImporter();
