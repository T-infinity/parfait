...
{
	    int n = isNodeData?mesh.numberOfNodes():mesh.numberOfBoundaryFaces();
		    floatFields.push_back(VtkField<float>(isNodeData,fieldName,1,n,data,boundaryNodeIdMap));
}
...
{
	    int n = isNodeData?mesh.numberOfNodes():mesh.numberOfBoundaryFaces();
		    doubleFields.push_back(VtkField<double>(isNodeData,fieldName,1,n,data,boundaryNodeIdMap));
}

template<class Mesh>
void VtkSurfaceWriter<Mesh>::addVectorField(bool isNodeData,string fieldName,int blockSize,int *data)
{
	    int n = isNodeData?mesh.numberOfNodes():mesh.numberOfBoundaryFaces();
		    intFields.push_back(VtkField<int>(isNodeData,fieldName,blockSize,n,data,boundaryNodeIdMap));
}

template<class Mesh>
void VtkSurfaceWriter<Mesh>::addVectorField(bool isNodeData,string fieldName,int blockSize,float *data)
{
	    int n = isNodeData?mesh.numberOfNodes():mesh.numberOfBoundaryFaces();
		    floatFields.push_back(VtkField<float>(isNodeData,fieldName,blockSize,n,data,boundaryNodeIdMap));
}

template<class Mesh>
void VtkSurfaceWriter<Mesh>::addVectorField(bool isNodeData,string fieldName,int blockSize,double *data)
{
	    int n = isNodeData?mesh.numberOfNodes():mesh.numberOfBoundaryFaces();
		    doubleFields.push_back(VtkField<double>(isNodeData,fieldName,blockSize,n,data,boundaryNodeIdMap));
}
