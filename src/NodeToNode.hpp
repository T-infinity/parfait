...
std::vector <std::vector<int>> NodeToNodeBuilder<MeshType>::buildNodeToNodeConnectivity() {
...
template <typename MeshType>
void NodeToNodeBuilder<MeshType>::processFace(int cell_id,int face_id){
...
template <typename MeshType>
std::vector<std::vector<int>> NodeToNodeBuilder<MeshType>::returnSetsAsVectors(){
