...
ParallelMeshImporter::ParallelMeshImporter(std::vector<std::string> gridFiles_in,vector<bool> &isBigEndian_in)
...
ParallelMeshImporter::~ParallelMeshImporter()
{
}

vector<int> ParallelMeshImporter::getGridNodeMap()
{
	return gridNodeMap;
}

vector<int> ParallelMeshImporter::getProcNodeMap()
{
	return procCellMap;
}

vector<int> ParallelMeshImporter::getProcCellMap()
{
...
void ParallelMeshImporter::distributeUgrid()
{
	if(0 == Rank())
...
void ParallelMeshImporter::buildDistributionMaps()
{
