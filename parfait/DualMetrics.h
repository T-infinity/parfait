...
void addPyramidDualMetrics(GetCell getCell, GetXyz getXyz, int numberOfCells, const std::vector<std::array<int, 2>>& edges,
                           DualMetrics& metrics) {
...
template <typename GetCell, typename GetXyz>
void addPrismDualMetrics(GetCell getCell, GetXyz getXyz, int numberOfCells, const std::vector<std::array<int, 2>>& edges,
                         DualMetrics& metrics) {
