...
namespace Parfait {
    ...
    public:
        ...
        static inline SyncPattern build(std::shared_ptr<MessagePasser> mp, const std::vector<long> &have_in, const std::vector<long> &need) {
        ...
        static inline SyncPattern build(std::shared_ptr<MessagePasser> mp,
        ...
        static std::vector<int> determineHowManyISendToEachRank(std::shared_ptr<MessagePasser> mp,
                                                                const std::vector<int> &need_from) {
        ...
        static inline std::map<int, std::vector<long>> getReceiveFrom(std::shared_ptr<MessagePasser> mp, const std::map<int, std::vector<long>>& send_to){
